...
Winedata <- read.csv(("/Users/SulMac/Desktop/MiskDSI/individual-assignment-2-SulAbid/data/winequality-red.csv"))
...
#Fixed Acidity and Wine Quality figure
...
```{r WineConclusion, echo=TRUE, message=FALSE}
#As we obsereve during EDA step , we have came to a conclusion :
#1- The highest quality wine is the one which has 11.55 and not less than 10.26 alchohol level
#2- pH levels must be around 3.27 and below 3.31 to be considerd as a good pH.
#3- The acidity level must be 8.82 and not less than 8.25 for a high quality
# The meduim quality has a positve skewed distribution shape in (Acidity levels) and (Alchohol levels)
# pH levels of all three categories was close to each others
# The mean of high level wine is closer to the med level mean than the low level mean .
